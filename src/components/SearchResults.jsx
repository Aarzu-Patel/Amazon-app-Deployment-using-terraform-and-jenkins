...
const SearchResults = () => {
  ...
  // Wrap getSearchResults in useCallback to avoid unnecessary re-renders
  ...
  }, [searchParams]); // Dependencies include searchParams to ensure updates

  // Correctly place useEffect outside of getSearchResults function
  useEffect(() => {
    getSearchResults();
  }, [getSearchResults]);
